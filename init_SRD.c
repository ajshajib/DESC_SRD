...
void init_priors(char *cosmoPrior1, char *cosmoPrior2, char *cosmoPrior3, char *cosmoPrior4)
{
  ...
  if (strcmp(cosmoPrior1, "Planck15_BAO_H070p6_JLA_w0wa") == 0)
    like.Aubourg_Planck_BAO_SN = 1;
  if (strcmp(cosmoPrior3, "PhotoBAO") == 0)
    like.BAO = 1;

  if (strcmp(cosmoPrior4, "stage3") == 0)
    like.SRD = 1;
  if (strcmp(cosmoPrior4, "Y10_SN") == 0)
    like.SRD = 2;
  if (strcmp(cosmoPrior4, "Y10_SL") == 0)
    like.SRD = 3;
  if (strcmp(cosmoPrior4, "Y10_3x2") == 0)
    like.SRD = 4;
  if (strcmp(cosmoPrior4, "Y10_CL") == 0)
    like.SRD = 5;
  if (strcmp(cosmoPrior4, "Y10_ALL") == 0)
    like.SRD = 6;

  if (strcmp(cosmoPrior4, "Y1_SN") == 0)
    like.SRD = 7;
  if (strcmp(cosmoPrior4, "Y1_SL") == 0)
    like.SRD = 8;
  if (strcmp(cosmoPrior4, "Y1_3x2") == 0)
    like.SRD = 9;
  if (strcmp(cosmoPrior4, "Y1_CL") == 0)
    like.SRD = 10;
  if (strcmp(cosmoPrior4, "Y1_ALL") == 0)
    like.SRD = 11;
}
...
void init_galaxies(char *SOURCE_ZFILE, char *LENS_ZFILE, char *lensphotoz, char *sourcephotoz, char *galsample)
{
  ...
  if (strcmp(galsample, "redmagic") == 0)
    set_clphotoz_priors_redmagic();
  if (strcmp(galsample, "benchmark") == 0)
    set_clphotoz_priors_benchmark();
  if (strcmp(galsample, "cmass") == 0)
    set_clphotoz_priors_cmass();
  if (strcmp(galsample, "SRD") == 0)
    set_clphotoz_priors_LSST_SRD();
  if (strcmp(galsample, "source") == 0)
    set_clphotoz_priors_source();
}
...
void init_lens_sample(char *lensphotoz, char *galsample)
{
  ...
  if (strcmp(lensphotoz, "voigt") == 0)
    redshift.clustering_photoz = 1;
  if (strcmp(lensphotoz, "voigt_out") == 0)
    redshift.clustering_photoz = 2;
  if (strcmp(lensphotoz, "gaussian") == 0)
    redshift.clustering_photoz = 3;
  if (strcmp(lensphotoz, "multihisto") == 0)
...
void init_source_sample(char *sourcephotoz)
{
  if (strcmp(sourcephotoz, "none") == 0)
    redshift.shear_photoz = 0;
  if (strcmp(sourcephotoz, "voigt") == 0)
    redshift.shear_photoz = 1;
  if (strcmp(sourcephotoz, "voigt_out") == 0)
    redshift.shear_photoz = 2;
  if (strcmp(sourcephotoz, "gaussian") == 0)
...
void init_IA(char *model, char *lumfct)
{
  if (strcmp(lumfct, "GAMA") == 0)
    set_LF_GAMA();
  else if (strcmp(lumfct, "DEEP2") == 0)
    set_LF_DEEP2();
  else
  {
  ...
  if (strcmp(model, "none") == 0)
    like.IA = 0;
  else if (strcmp(model, "NLA_HF") == 0)
    like.IA = 1;
  else if (strcmp(model, "lin") == 0)
    like.IA = 2;
  else
  {
