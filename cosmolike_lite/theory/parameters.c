...
void set_cosmological_parameters_to_wphicdm();
...
void set_cosmological_parameters_to_wphicdm()
{
  cosmology.Omega_m = 0.318;
  cosmology.Omega_v = 1 - 0.318;
  cosmology.sigma_8 = 0.7974256929953139;
  cosmology.n_spec = 0.972;
  ...
  //   h0: 0.667 +0.673 -0.661
  // omega_m: 0.318 +0.324 -0.312
  // w: -0.908 +-0.874 --0.944
  // wa: 1.456 +1.521 -1.384
  // omega_b: 0.051 +0.052 -0.050
  // mnu: 0.077 +0.102 -0.065
  // n_s: 0.972 +0.975 -0.969
  // a_s: 0.000 +0.000 -0.000
  // a_planck: 1.001 +1.003 -0.999
  // sigma_8: 4481.089 +4484.933 -4476.735

  cosmology.rho_crit = 7.591658654888752e+21;
  printf("Cosmology set to wPhiCDM\n");
  cosmology.f_NL = 0.0;
}
