...
void set_HOD_redmagic_priors()
{
  flat_prior.HOD_rm[0][0] = 10.0;
  flat_prior.HOD_rm[0][1] = 15.0;
  flat_prior.HOD_rm[1][0] = 0.1;
  flat_prior.HOD_rm[1][1] = 1.0;
  flat_prior.HOD_rm[2][0] = 10.0;
  flat_prior.HOD_rm[2][1] = 15.0;
  flat_prior.HOD_rm[3][0] = 10.0;
  flat_prior.HOD_rm[3][1] = 15.0;
  flat_prior.HOD_rm[4][0] = 0.5;
  flat_prior.HOD_rm[4][1] = 1.5;
  flat_prior.fc_rm[0] = 0.1;
  flat_prior.fc_rm[1] = 1.0;
  flat_prior.cg_rm[0] = 0.2;
  flat_prior.cg_rm[1] = 5.;
}
...
double log_like_f_red()
{ // use f_red in each tomography bin to constrain LF parameters, assuming 10% uncertainty in f_red measurement; evaluated at bin center to avoid cosmology dependence
  static double **table;
  int i;
